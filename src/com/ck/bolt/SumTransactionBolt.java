...
/**
 * @author xuer
 * @date 2014-10-16 - 上午10:10:46
 * @Description继承ICommitter或者setCommitterBolt来标示此为commiter bolt
 */
public class SumTransactionBolt extends BaseTransactionalBolt implements ICommitter {
  ...
  public void execute(Tuple tuple) {
    System.err.println("count:" + tuple.getInteger(1));
