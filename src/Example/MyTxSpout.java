...
public class MyTxSpout implements ITransactionalSpout<MyMata> {
  ...
  public MyTxSpout() {
    ...
    String[] time =
        {"2014-01-07 08:40:50", "2014-01-07 08:40:51", "2014-01-07 08:40:52",
            "2014-01-07 08:40:53", "2014-01-07 09:40:49", "2014-01-07 10:40:49",
            "2014-01-07 11:40:49", "2014-01-07 12:40:49"};

    for (long i = 0; i < 100; i++) {
      dbMap
          .put(i, hosts[0] + "\t" + session_id[random.nextInt(5)] + "\t" + time[random.nextInt(8)]);
    }
  }
  ...
  @Override
  public backtype.storm.transactional.ITransactionalSpout.Emitter<MyMata> getEmitter(Map conf,
